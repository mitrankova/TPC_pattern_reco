...
class FinalTrackVertexv1 : public FinalTrackVertex
{
 public:
  FinalTrackVertexv1();
  ~FinalTrackVertexv1() override = default;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override;
  int isValid() const override;
  PHObject* CloneMe() const override { return new FinalTrackVertexv1(*this); }
 ...
 private:
  ...
  ClassDefOverride(FinalTrackVertexv1, 1)
};
