...
class FullTrackVertexContainer : public PHObject
{
 public:
  ...
  virtual double get_collision_radius(unsigned int) const { return 0.0; }
  virtual double get_collision_phi(unsigned int) const { return 0.0; }
  virtual double get_collision_timebin(unsigned int) const { return 0.0; }
  virtual double get_collision_timebin_rms(unsigned int) const { return 0.0; }
  virtual unsigned int get_collision_ntracks(unsigned int) const { return 0; }
