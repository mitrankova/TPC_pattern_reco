...
class FinalTrackVertexContainerv1 : public FinalTrackVertexContainer
{
 public:
  FinalTrackVertexContainerv1();
  ~FinalTrackVertexContainerv1() override;
  ...
  void add_vertex(FinalTrackVertex* vtx) override { m_vertices.push_back(vtx); }
  const FinalTrackVertex* get_vertex(unsigned int i) const override;
  FinalTrackVertex* get_vertex(unsigned int i) override;
 ...
 private:
  std::vector<FinalTrackVertex*> m_vertices;
  ...
  ClassDefOverride(FinalTrackVertexContainerv1, 1)
};
