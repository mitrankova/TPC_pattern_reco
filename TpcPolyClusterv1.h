...
class TpcPolyClusterv1 : public TpcPolyCluster
{
 public:
  TpcPolyClusterv1();
  ~TpcPolyClusterv1() override = default;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override;
  int isValid() const override;
  PHObject* CloneMe() const override { return new TpcPolyClusterv1(*this); }
 ...
 private:
  ...
  ClassDefOverride(TpcPolyClusterv1, 1)
};
