...
class FinalTrackVertexer : public SubsysReco
{
 public:
  explicit FinalTrackVertexer(const std::string& name = "FinalTrackVertexer");
  ~FinalTrackVertexer() override = default;
 ...
 private:
  ...
  TrackVertexFit fitTrack(const FinalTrack* trk) const;
  ...
  FinalTrackVertexContainer* m_vertices {nullptr};
